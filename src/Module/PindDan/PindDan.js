...
import Style from "./PindDan.module.css";
...
const PindDan = ({ data }) => {
  return (
    <div>
      <div className="relative w-full h-[45vh] object-contain">
      ...
      <div className="flex flex-col md:space-x-10 md:flex-row px-[5vw] md:px-[15vw]">
        <div className="md:w-2/3">
          ...
          <div className="flex mt-3">
            <ul className="list-disc ml-2">
              {data.tourSummary.map((li) => (
                <li className="font-montserrat text-sm text-[#8c8c8c]">{li}</li>
              ))}
            </ul>
          </div>
          {/* Itinerary */}
          ...
          <div className="border-[#e1e1e1] border-b-2"></div>
          {/* Suggestions */}
        ...
        <div className="md:w-1/3">
          ...
          {/* Container 3 */}
          <div className="w-full h-[30vh] flex justify-center items-center  px-auto mt-[15vh] bg-[#f97150]">
            <div className="w-3/4">
